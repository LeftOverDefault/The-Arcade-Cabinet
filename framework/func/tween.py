from framework.func.ease import Ease
...
class Tween:
    def __init__(self, begin: float = 0.0, end: float = 1.0, duration: int = 600, easing: Easing = Easing.LINEAR, easing_mode: EasingMode = EasingMode.IN, boomerang: bool = False, loop: bool = False, reps: int = 0):
