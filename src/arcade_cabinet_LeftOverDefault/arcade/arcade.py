...
from arcade_cabinet_LeftOverDefault.arcade.classes.configure import Configure
from arcade_cabinet_LeftOverDefault.arcade.debug.debugger import Debugger
